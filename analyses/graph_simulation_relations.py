...
ax1.scatter(ks, k_props_100mnh_s, color="r", s=2, label="TNA s")
ax1.scatter(ks, k_props_100mnh_l, color="g", s=2, label="TNA l")
plt.xlabel('k')
...
ax1.scatter(ns, n_props_100mnh_s, color="r", s=2, label="TNA s")
ax1.scatter(ns, n_props_100mnh_l, color="g", s=2, label="TNA l")
plt.xlabel('n')
